...
export const totalAddWorkspaceSteps = 5;
...
export function getAddWorkspaceValidationMessage(step: number, formData: AddWorkspaceFormData) {
  if (step === 1) return "Please fill in all required fields: Workspace Name, Type, and City";
